...
<div id="upload-doc-modal" style="display:none;">
    ...
    <form action="upload.php" method="post" class="doc-form" enctype="multipart/form-data">
        ...
        <?php echo $tpl->render( 'ld-select-input', array( "id" => "section-select-input", "name" => "section", "label" => "Section", "options" => "sections")); ?>
        <?php echo $tpl->render( 'ld-select-input', array( "id" => "parent-doc-select-input", "name" => "parent-doc", "label" => "Parent Document", "options" => $docs)); ?>
