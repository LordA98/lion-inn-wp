...
jQuery(function ($) {
    ...
    function setPostVarFromButton($inputName, $caller) {
        $parentListItemId = $($caller).parent().siblings(".menu-id").text();
        $('input[name=' + $inputName + ']').val($parentListItemId);
    }
    ...
    function setCheckboxFromButton($inputName, $caller) {
        $checked = $($caller).parent().siblings('.published').text();
        ($checked == 1) ? ($('input[name=' + $inputName + ']').prop('checked', true)) : ($('input[name=' + $inputName + ']').prop('checked', false));
    ...
    function setTextInputFromButton($inputName, $caller) {
        $value = $($caller).parent().prev('h1').text();
        console.log($value);
        $('input[name=' + $inputName + ']').val($value);
    }
