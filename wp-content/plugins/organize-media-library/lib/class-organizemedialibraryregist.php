...
class OrganizeMediaLibraryRegist {
	...
	public function register_settings() {
		...
		if ( ! get_option( $wp_options_name ) ) {
			...
			if ( array_key_exists( 'exclude_folders', $organizemedialibrary_settings ) ) {
				$exclude_folders = $organizemedialibrary_settings['exclude_folders'];
			}
			if ( array_key_exists( 'emu_subdir_change', $organizemedialibrary_settings ) ) {
				$emu_subdir_change = $organizemedialibrary_settings['emu_subdir_change'];
			}
		}
		$organizemedialibrary_tbl = array(
			...
			'emu_subdir_change' => $emu_subdir_change,
		);
	 ...
	 *
	 * @param array $organizemedialibrary_settings  organizemedialibrary_settings.
	 * @return string $dirs
	 * @since 6.39
	 */
